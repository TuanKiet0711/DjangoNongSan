...
from .views import giohang as giohang            # UI trang giỏ hàng
from .views import giohang_api as cart           # ✅ API giỏ hàng (tách khỏi đơn hàng)
from .views import sanpham_view as spv            # ✅ ĐỔI: dùng product_api cho API + admin
from .views import donhang, donhang_view as dv   # UI + API đơn hàng
...
urlpatterns = [
    ...
    # --------- ✅ API Sản phẩm (product_api, snake_case) ---------
    ...
    # --------- Admin (dùng view trong product_api) ---------
